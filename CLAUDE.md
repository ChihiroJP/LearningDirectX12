...
You are working with **LEE CHEE HOW**, a directx12 developer, researcher. Work spans:

1. **DirectX12 Game Develop**: [My project is focusing on working with DirectX12 to develop game]
2. **C++, DirectX and Game Studies.**: [I always study for directx, C++, and Game research]
